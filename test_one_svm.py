...
#classif = ml.clf_e.LSTM(dataset, check_point_path=check_point_path, pprint=False, timesteps=7)
classif = ml.clf_e.GPC(kernel=GPy.kern.sde_StdPeriodic, k_params={"variance":1., "period": 3}, dataset=dataset, check_point_path="/home/sc/ml_data/checkpoints/", pprint=False)
classif.train(batch_size=128, num_steps=40)
